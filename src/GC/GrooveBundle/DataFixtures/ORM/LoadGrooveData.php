...
namespace GC\GrooveBundle\DataFixtures\ORM;
...
use GC\GrooveBundle\Entity\User;

class LoadGrooveData implements FixtureInterface, ContainerAwareInterface, OrderedFixtureInterface
{
    private $container;
