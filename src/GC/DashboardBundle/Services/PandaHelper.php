...
class PandaHelper {
  ...
  protected $panda;
    ...
    public function __construct($logger) {
    	$this->logger = $logger;
      $this->panda = new Panda(array(
          'api_host'   => "api.pandastream.com",
          'cloud_id'   => "b65bd64388722545009b299ff7a5ff50",
          'access_key' => "a4ebd0c05d4aa38637c7",
          'secret_key' => "29ac904de4553b5bb906",
      ));      
    }	

    public function upload($file, $dest) {
      $res = $this->panda->post('/videos.json', array(
          'file' => $file,
          'path_format' => "$dest/:id"
      ));
